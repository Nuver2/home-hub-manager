...
ARG VITE_SUPBASE_URL
ARG VITE_SUPBASE_PUBLISHABLE_KEY
ARG VITE_VAPID_PUBLIC_KEY

# Set as environment variables for the build
ENV VITE_SUPBASE_URL=$VITE_SUPBASE_URL
ENV VITE_SUPBASE_PUBLISHABLE_KEY=$VITE_SUPBASE_PUBLISHABLE_KEY
